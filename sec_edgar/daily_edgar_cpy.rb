...
def parse_edgar(cmp_detail = {})
  ...
  begin
    ...
    puts "Skipping this filing due to error #{e.error}"
    return
  end
  begin
    ...
    puts "Rescued XML error #{e.error} ,skipped this filing #{cmp_cik} .... #{cmp_ticker}"
    return
  end
  ...
  quote = Quandl::DailyData.scrape_data(cmp_ticker,@tdate[0])
